...
exports.create = function(launcher, options, callback) {
    ...
    app.get('/capture', function(req, res) {
        var browsers = _.keys(options.browsers)
    ...
    if (options.manager) {
        ...
        app.post('/hub/register', function(req, res) {
            ...
            if (client ) {
                ...
                var clientAddr = _.keys(clients)[0]
                if (clients[clientAddr]) {
                    console.warn('Duplicate registration!(' + clientAddr + ')')
                }
        ...
        app.get('/hub/managers', function(req, res) {
            var managers = _.keys(manager.clients)
            res.send(managers);
        })
    }
