...
var qryVersion = 'reg query "' + util.getRegBasePath() + 'Google\\Update\\Clients" /s'
var qryPath = 'reg query "' + util.getRegBasePath() + 'Google\\Update" /s /v LastInstallerSuccessLaunchCmdLine'
