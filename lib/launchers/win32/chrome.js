...
var qryVersion = 'req query "' + util.getRegBasePath() + 'Google\\Update\\Clients" /s'
var qryPath = 'reg query "' + util.getRegBasePath() + 'Google\\Update" /v LastInstallerSuccessLaunchCmdLine'
